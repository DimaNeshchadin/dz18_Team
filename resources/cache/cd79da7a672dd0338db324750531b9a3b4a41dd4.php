                ...
                <div class="row columns_margin_bottom_40">
                    <div class="col-md-4 col-sm-6">
                        <div class="teaser text-center">
                            <img src="images/services-icons/01.png" alt="" />
                            <h4>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="teaser text-center">
                            <img src="images/services-icons/02.png" alt="" />
                            <h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-sm-offset-3 col-md-offset-0">
                        <div class="teaser text-center">
                            <img src="images/services-icons/03.png" alt="" />
                            <h4>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center to_animate" data-animation="fadeInUp">
                        ...
                        <form class="contact-form row columns_margin_bottom_20" method="post" action="layouts">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /src/app/resources/views/home.blade.php ENDPATH**/ ?>